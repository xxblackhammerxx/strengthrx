...
Plans:
- [x] 01-01-PLAN.md — Add onboarding fields to Clients, run migrations, install form libraries, write integration tests
...
**Requirements**: INTEG-01, INTEG-02, INTEG-03, INTEG-04, INTEG-05, INTEG-06, POST-01, POST-02
**Success Criteria** (what must be TRUE):
  1. Completing the form creates a client record in Payload and the user is automatically logged into the client portal
  2. A Practice Better patient record is created via real API and the practiceBetterSyncStatus field reflects the outcome (synced or failed)
