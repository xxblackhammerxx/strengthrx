...
export function Hero() {
  return (
    <section className="relative bg-gradient-to-br from-primary/5 via-white to-secondary/5 pt-16 pb-20 sm:pt-24 sm:pb-32">
      <Container>
      ...
      <div className="absolute inset-0 -z-10 overflow-hidden">
        ...
        <div
          className="absolute top-3/4 right-1/4 w-96 h-96 bg-secondary/10 rounded-full blur-3xl opacity-20 animate-bounce-gentle"
