...
export const metadata: Metadata = {
  ...
  description:
    'StrengthRX privacy policy outlining how we collect, use, and protect your personal health information.',
  alternates: {
    canonical: '/privacy',
  },
  robots: {
    ...
    <div className="py-16 sm:py-24">
      <Container size="md">
        <div className="prose max-w-none">
          ...
          <p>
            StrengthRX ("we," "our," or "us") is committed to protecting your privacy and personal
            health information. This Privacy Policy explains how we collect, use, disclose, and
            safeguard your information when you use our telehealth services and website.
          </p>
          ...
          <ul>
            <li>
              <strong>Healthcare Providers:</strong> Licensed physicians and medical staff involved
              in your care
            </li>
            <li>
              <strong>Service Providers:</strong> Third-party vendors who assist with our operations
              (e.g., laboratory services, payment processing)
            </li>
            <li>
          ...
          <p>
            ...
            Accountability Act (HIPAA) and other applicable privacy laws. Your protected health
            information (PHI) is handled according to HIPAA requirements, and you have specific
          ...
          <div className="mt-8 p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
            <p className="text-sm text-yellow-800">
              <strong>Notice:</strong> This is a sample privacy policy for demonstration purposes.
              In a real application, you should work with legal counsel to ensure compliance with
