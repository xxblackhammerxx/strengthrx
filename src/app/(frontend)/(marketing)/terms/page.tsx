...
export default async function TermsPage() {
  const statesList = await getPrescriptionStatesList()
    ...
    <div className="py-16 sm:py-24">
      <Container size="md">
        <div className="prose max-w-none">
          ...
          <p>
            By accessing or using StrengthRX services, you agree to be bound by these Terms of
            Service ("Terms"). If you do not agree to these Terms, please do not use our services.
          </p>

          <h2>2. Description of Services</h2>
          <p>
            StrengthRX provides telehealth wellness optimization services, including but not limited
            to:
          </p>
          <ul>
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
            <p className="text-yellow-800 mb-0">
              <strong>Important:</strong> StrengthRX services are for educational and informational
              purposes and do not replace the relationship between you and your primary care
              physician. Our services are not intended to diagnose, treat, cure, or prevent any
              disease. Always consult with a qualified healthcare provider before making any medical
              decisions.
            </p>
          </div>
          ...
          <p>Our services operate on a direct-pay model. By using our services, you agree to:</p>
          <ul>
          ...
          <p>If prescribed medications, you acknowledge that:</p>
          <ul>
          ...
          <p>
            We are committed to protecting your privacy in accordance with HIPAA and other
            applicable laws. Please review our Privacy Policy for detailed information about how we
            handle your personal health information.
          </p>
          ...
          <p>
            To the fullest extent permitted by law, StrengthRX and its providers shall not be liable
          ...
          <p>
            You agree to indemnify and hold harmless StrengthRX from any claims, damages, or
            expenses arising from your use of our services or violation of these Terms.
          </p>

          <h2>13. Termination</h2>
          <p>
            Either party may terminate the service relationship at any time. StrengthRX reserves the
            right to terminate services for violation of these Terms or for any reason deemed
            necessary for patient safety or legal compliance.
          </p>
          ...
          <p>
            ...
            significant changes, and your continued use of our services constitutes acceptance of
            the modified Terms.
          </p>
          ...
          <div className="bg-red-50 border border-red-200 rounded-lg p-4">
            <p className="text-red-800 mb-2">
              <strong>Emergency Situations:</strong> If you are experiencing a medical emergency, do
              not use our telehealth services. Instead:
            </p>
          ...
          <div className="bg-muted p-4 rounded-lg">
            ...
            <p className="mb-2">
              Email:{' '}
              <a href={businessConfig.email.href} className="text-primary hover:underline">
          ...
          <div className="mt-8 p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
            <p className="text-sm text-yellow-800">
              <strong>Legal Notice:</strong> These are sample terms of service for demonstration
              purposes. In a real application, you should work with qualified legal counsel to
              ensure compliance with all applicable laws and regulations, including state-specific
